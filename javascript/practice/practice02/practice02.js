...
//함수 선언문으로 함수 정의
function getMealByTime(a){
    if(a>=6 && a <=10){return '아침';} 
    else if(a>=11 && a<=14){return '점심';} 
    else if(a>=17 && a<=20){return '저녁';} 
    else if(a>=21 && a<=23){return '야식';} 
    else {return '금식';}   
}

//익명 함수 ( 화살표로 함수 정의)
const getMealByTime = (a)=> {
    if(a>=6 && a <=10){return '아침';} 
    else if(a>=11 && a<=14){return '점심';} 
    else if(a>=17 && a<=20){return '저녁';} 
    else if(a>=21 && a<=23){return '야식';} 
...
//함수 표현식으로 함수 정의 (익명 함수)
const getMealByTime = function(a) {
    if(a>=6 && a <=10){return '아침';} 
    else if(a>=11 && a<=14){return '점심';} 
    else if(a>=17 && a<=20){return '저녁';} 
    else if(a>=21 && a<=23){return '야식';} 
...
//함수 표현식으로 함수 정의 (네이밍 함수)
const getMealByTime = function getMealByTime(a) {
    if(a>=6 && a <=10){return '아침';} 
    else if(a>=11 && a<=14){return '점심';} 
    else if(a>=17 && a<=20){return '저녁';} 
    else if(a>=21 && a<=23){return '야식';} 
